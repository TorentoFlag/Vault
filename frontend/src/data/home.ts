...
export const faqItems: FAQ[] = [
  {
    id: "safe-payment",
    group: "Безопасность",
    question: "Безопасно ли оплачивать через СБП?",
    answer: "Оплата проходит на защищённой платёжной странице СБП. Vault получает только статус платёжной сессии и не зачисляет Coins по возврату в браузер.",
  },
  {
    id: "payment-methods",
    group: "Безопасность",
    question: "Какой способ оплаты доступен?",
    answer: "В текущем релизе доступен только СБП. Подтверждение платежа выполняется на странице провайдера.",
  },
  {
    id: "receipt",
    group: "Безопасность",
    question: "Выдаёте ли вы официальный чек после покупки?",
    answer: "Платёж проводится через платёжного провайдера. Данные по подтверждённому платежу и заказу сохраняются в истории аккаунта; условия выдачи чека указаны в пользовательском соглашении.",
  },
  {
    id: "charged",
    group: "Безопасность",
  ...
  },
  {
    id: "refund-time",
    group: "Возвраты",
    question: "Как быстро возвращается платёж после одобрения возврата?",
