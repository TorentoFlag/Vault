...
- Frontend: Next.js 16, React 19, TypeScript, CSS Modules, backend-fed public catalog pages, plus server-backed cart/checkout, Steam Trade URL saving, purchase history, inventory projection, and top-up session creation when a real backend cookie session is present.
